#!/usr/bin/env python3
"""
Добавляет полные ограничения (outfit, weather, lighting, props) во все TOML-файлы локаций.
"""
...
def fix_all_locations():
    """Добавляет недостающие ограничения во все файлы локаций"""
    ...
    # Матрица ограничений для каждой локации
    location_constraints = {
        "bedroom": {
            ...
            "excludes_props": ["frying_pan", "knife", "surfboard", "beach_ball"]
        },
        "kitchen": {
            ...
            "excludes_props": ["bed", "pillow", "blanket", "surfboard"]
        },
        "bathroom": {
        ...
        "library": {
            ...
            "excludes_props": ["bed", "frying_pan", "knife", "surfboard", "beach_ball"]
        },
        "cafe": {
            "allowed_outfit_categories": ["topwear", "bottomwear", "legwear", "footwear"],
            "excludes_outfit_categories": ["swimsuit", "full_body"],
            ...
            "excludes_props": ["bed", "pillow", "blanket", "frying_pan", "knife", "surfboard"]
        },
        "beach": {
        ...
        "park": {
            "allowed_outfit_categories": ["topwear", "bottomwear", "legwear", "footwear"],
            "excludes_outfit_categories": ["swimsuit", "full_body"],
            "excludes_weather": ["storm", "heavy rain"],
            "excludes_lighting_sources": ["fluorescent light", "neon light", "lamplight"],
            "excludes_props": ["bed", "frying_pan", "knife", "laptop"]
        },
        "street": {
            "allowed_outfit_categories": ["topwear", "bottomwear", "legwear", "footwear"],
            "excludes_outfit_categories": ["swimsuit", "full_body"],
    ...
    for filename, constraints in location_constraints.items():
        ...
        try:
            ...
            # Добавляем ограничения в hard_constraints
    ...
    print("Пижам в кафе и кроватей в библиотеке больше не будет! 🎉")
